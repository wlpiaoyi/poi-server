 ...
 * {@code @version:}:       1.0
 */
public class DataStyleXSSFUtils {


    public static XSSFCellStyle setCellStyle(XSSFCell cell, DataStyle dataStyle){
    ...
    public static void synCellBorderStyle(XSSFCellStyle cellStyle){
    ...
    public static void synFont(XSSFFont font, DataStyle dataStyle) {
