 ...
 * {@code @version:}:       1.0
 */
public class DataStyleHSSFUtils {

    public static HSSFCellStyle setCellStyle(HSSFCell cell, DataStyle dataStyle){
    ...
    public static void synCellBorderStyle(HSSFCellStyle cellStyle){
    ...
    public static void synFont(HSSFFont font, DataStyle dataStyle) {
